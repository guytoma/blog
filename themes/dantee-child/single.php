...
<?php } ?>
	...
	<?php
		...
		$post_author = '<a href="'.get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ).'">'.get_the_author().'</a>';
	...
	<div class="inner-page-wrap ca_single_post_inner_page_wrap <?php echo $page_wrap_class; ?> clearfix">
		...
		<?php } ?>
				...
				?>
							...
							<img src="<?php echo $ca_fetured_bg; ?>" alt="The post thumbnail">

							<style>

								.ca_post_thumbnail {

									background: url('<?php echo $ca_fetured_bg; ?>') center center no-repeat;
				...
				<div class="entry-title ca_title"><h1><?php the_title(); ?></h1></div>
				...
				<div class="post-info clearfix ca_post_meta">

					<?php if ($single_author && !$remove_dates) { ?>

						<span><?php echo sprintf(__('Posted on <span class="date updated">%1$s</span>', 'swiftframework'), $post_date, $post_categories); ?></span>
					...
					<?php } else if ($remove_dates) { ?>
						...
						<span class="vcard author"><?php echo sprintf(__('Posted by <span itemprop="author" class="fn">%1$s</span>', 'swiftframework'), $post_author, $post_categories); ?></span>

					<?php } else { ?>

						<span class="vcard author"><?php echo sprintf(__('Posted by <span itemprop="author" class="fn">%1$s</span> on <span class="date updated">%2$s</span>', 'swiftframework'), $post_author, $post_date, $post_categories); ?></span>
